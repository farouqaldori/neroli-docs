...
Neroli should feel immediate: open the app, pick a repo, launch a session, and
keep moving.
...
Open Neroli, choose a repository, and start a session. The app creates an
isolated workspace for that run and launches the provider TUI directly inside
the UI.
...
<Steps>
  ...
  <Step title="Launch an agent">
    Start Claude, Codex, opencode, or another provider from a new isolated session.
  </Step>
