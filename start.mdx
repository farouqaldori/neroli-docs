...
Open the app, pick a repo, choose your agent, and keep moving. Claude, Codex,
OpenCode, or another provider can all fit the same workspace.
...
Next: understand the core model in [Concepts](/concepts), then make every new
session easier with [Automations](/automations).
