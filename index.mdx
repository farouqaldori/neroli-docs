...
Neroli is a blazing-fast Mac app for running coding agents in parallel. Bring
Claude, Codex, opencode, or whichever provider you like. Use one, switch
between them, or run several at once.

Neroli does not try to replace your favorite agent. It sits one layer above it:
isolated sessions, visible panes, workspace automations, and smooth
