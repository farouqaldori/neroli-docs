...
| Verify Merge lane | Runs checks or starts review agents for sessions waiting in Merge. |
| Cleanup Done lane | Archives or summarizes completed sessions after validation. |
...
- place group-level actions on the sidebar lanes where you use them
...
Next: use [Recipes and gotchas](/recipes) to turn automations into isolated dev sessions, cloud handoff, lane actions, and review workflows.
