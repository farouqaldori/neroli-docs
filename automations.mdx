...
Agents launched inside Neroli know about the current session, visible panes, and
available automations, so they can use the same workspace controls you do.
