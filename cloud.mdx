...
<Frame caption="A session can move local to cloud, keep working, then move cloud to local without tying the work to one provider.">
...
- keep using Claude, Codex, opencode, or other supported providers without locking the work to one place
...
- provider/session metadata where supported
