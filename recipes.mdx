...
<Steps>
  <Step title="Pick the lane">
    Choose the group where the work naturally gathers: In Review, Merge, Done, or another stage.
  </Step>

  <Step title="Create the action">
    Add a sidebar automation for that group. It can inspect the sessions in the lane and act on the first or all of them.
  </Step>
...
```txt
Create a Neroli automation for the In Review lane.
...
| A lane repeats the same manual work | Add a sidebar automation for that group. |
