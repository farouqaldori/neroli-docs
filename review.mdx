...
The normal flow is not to read every line cold. Ask the agent to review its own
work first: explain the change, check the diff, run the right automations, fix
anything obvious, and leave you with a clean summary. Then you decide what lands.
...
<Steps>
  ...
  <Step title="Read the result">
    Start from the agent's review summary, then inspect the files that matter: product code, tests, migrations, scripts, config, and docs.
  </Step>
